...
define("models/enums&ProjectClass", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("state/project-state", ["require", "exports", "models/enums&ProjectClass"], function (require, exports, enums_ProjectClass_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectState extends State {
        ...
        addProject(title, description, numOfPeople) {
            const newProject = new enums_ProjectClass_js_1.Project(Math.random().toString(), title, description, numOfPeople, enums_ProjectClass_js_1.ProjectStatus.Active);
...
define("components/project-list", ["require", "exports", "components/base-component", "decorators/autobind", "models/enums&ProjectClass", "components/project-item", "state/project-state"], function (require, exports, base_component_js_3, autobind_js_3, enums_ProjectClass_js_2, project_item_js_1, project_state_js_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_js_3.Component {
        ...
        renderProjects() {
            ...
            for (const project of this.assignedProjects) {
                ...
                const projectItem = new project_item_js_1.ProjectItem(`${this.listType}-projects-list`, project);
            }
        }
        configure() {
            ...
            project_state_js_2.projectState.addListener((projects) => {
                const relevantProjects = projects.filter((project) => {
                    if (this.listType === "finished") {
                        return project.projectStatus === enums_ProjectClass_js_2.ProjectStatus.Finished;
                    }
                    else {
                        return project.projectStatus === enums_ProjectClass_js_2.ProjectStatus.Active;
                    }
                });
        ...
        dropHandler(event) {
            ...
            project_state_js_2.projectState.moveProject(projectId, this.listType === "active"
                ? enums_ProjectClass_js_2.ProjectStatus.Active
                : enums_ProjectClass_js_2.ProjectStatus.Finished);
        }
